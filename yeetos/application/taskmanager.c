...
// task stacks
STACK_ATTR static uint8_t stack_idle[128];
STACK_ATTR static uint8_t stack_event0[128];
STACK_ATTR static uint8_t stack_event1[128];
STACK_ATTR static uint8_t stack_event2[128];
STACK_ATTR static uint8_t stack_event3[128];
...
void taskmanager_start() {
	scheduler_init();
	scheduler_addTask(0, 0, idle_task, stack_idle, 128);  //idle task
	scheduler_addTask(1, 1, event_queue_task, stack_event0, 128);
	scheduler_addTask(2, 1, event_queue_task, stack_event1, 128);
	scheduler_addTask(3, 1, event_queue_task, stack_event2, 128);
	scheduler_addTask(4, 1, event_queue_task, stack_event3, 128);
